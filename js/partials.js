...
'    Firstly, you need to read the brunch.io documentation once. We are using &nbsp;<a href="http://brunch.io">brunch.io</a>&nbsp; to expedite the development process.',
'  </p>',
...
'<div class="row-fluid">',
'  <div class="span6">',
'    <h2>Real-time Tweets Visualization</h2>',
'    <p><span class="label label-important">Goal:</span> Design and implement web-app that allows monitoring and visual ',
'      comparison of Twitter trends (number of tweets) by keyword search. Visual representation should be implemented as a dynamic chart with following features:',
'      control of keyword list, manual and auto update, showing last tweet for trend, etc.',
'    </p>',
'    <p><span class="label label-info">Tools/languages :</span> JavaScript,' +
'       <a href="http://jquery.com/">jQuery,</a>' +
'       <a href="http://twitter.github.io/bootstrap/">Twitter Bootstrap,</a>' +
'       <a href="http://d3js.org/">D3js</a>' +
'    </p>',
'    <p>',
'      <button type="button" data-toggle="modal" data-target="#project5" class="btn-medium btn">More Details</button>',
'    </p>',
'  </div>',
'  <div class="span6">',
'    <h2>Facebook Graph Visualization</h2>',
'    <p><span class="label label-important">Goal:</span> Design and implement web-app that allows to represent user\'s facebook ',
'       friends in the form of graph, access their profile information, their friends and connection between them.',
'    </p>',
'    <p><span class="label label-info">Tools/languages :</span> JavaScript,' +
'       <a href="http://jquery.com/">jQuery,</a>' +
'       <a href="http://twitter.github.io/bootstrap/">Twitter Bootstrap,</a>' +
...
'    </p>',
'    <p>',
'      <button type="button" data-toggle="modal" data-target="#project6" class="btn-medium btn">More Details</button>',
'    </p>',
'  </div>',
'</div><!--/row-->',
'<div class="row-fluid">',
...
'      <p>',
'        Using JavaScript, it has become possible to make interactive data grids/spreadsheets like the google',
'        spreadsheet. The objective is to make an interactive data grid using ngGrid of AngularJS.',
'      </p>',
'      <p>',
'        ngGrid is a well documented library written using AngularJS and JQuery. Its well documented and with',
'        lot of &nbsp;<a href="http://angular-ui.github.com/ng-grid/">examples</a>. In this project you will have to build a data grid which is fluid (resizes smoothly on window resize)',
'        and the data of each cell can edited by clicking on it just like in google spreadsheet.',
'      </p>',
'    </div>',
...
'    <div class="modal-header">',
'      <button type="button" data-dismiss="modal" aria-hidden="true" class="close">×</button>',
'      <h3>AngularJS Service for table parsing</h3>',
'    </div>',
'    <div class="modal-body">',
'      <p></p>',
'    </div>',
...
'    <div class="modal-footer"></div>',
'  </div>',
'  <div id="project5" class="modal hide fade wide-modal">',
'    <div class="modal-header">',
'      <button type="button" data-dismiss="modal" aria-hidden="true" class="close">×</button>',
'      <h3>Real-time Tweets Visualization</h3>',
'    </div>',
'    <div class="modal-body">',
'       <p>Mockup of proposed web-app interface: </p>',
'       <img src="img/tweetviz.png">',
'       <ul>',
'         <li>',
'           <p>Mark up should be implemented using Twitter Bootstrap standard ' +
'             <a href="http://twitter.github.io/bootstrap/scaffolding.html">scaffolding</a>, ' +
'             <a href="http://twitter.github.io/bootstrap/base-css.html">css classes</a>, and ' +
'             <a href="http://twitter.github.io/bootstrap/components.html">UI components</a>.' +
'           </p>',
'         </li>',
'         <li>',
'           <p>Information about tweets may be retrieved through ' +
'             <a href="https://dev.twitter.com/docs/api/1.1">Twitter REST API v1.1</a>.',
'             In interaction with API ' +
'             <a href="https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest">XMLHttpRequests</a>',
'             should be sent using <a href="http://api.jquery.com/jQuery.ajax/">jQuery Ajax</a>.',
'           </p>',
'         </li>',
'         <li>',
'           <p>For plotting results one of <a href="https://github.com/mbostock/d3/wiki/Gallery">D3js charts</a>' +
'              should be used. For example, <a href="http://bl.ocks.org/mbostock/3884955">Multi-Series Line Chart</a>.',
'           </p>',
'         </li>',
'         <li>',
'           <p>On mouse hover the last tweet for the trend should be shown in ' +
'              <a href="http://twitter.github.io/bootstrap/javascript.html#popovers">popover</a>.',
'           </p>',
'         </li>',
'         <li>',
'           <p>User should be able to add up to 5 search terms in list, delete, and control their appearance in the chart.',
'           </p>',
'         </li>',
'         <li>',
'           <p>Chart should be automatically updated every 15 sec if checkbox is selected. Or by button "Update now".',
'           </p>',
'         </li>',
'       </ul>',
'    </div>',
'    <div class="modal-footer"></div>',
'  </div>',
'  <div id="project6" class="modal hide fade wide-modal">',
'    <div class="modal-header">',
'      <button type="button" data-dismiss="modal" aria-hidden="true" class="close">×</button>',
'      <h3>Real-time Tweets Visualization</h3>',
'    </div>',
...
'         <li>',
'           <p>Information about tweets may be retrieved through ' +
'             <a href="https://developers.facebook.com/docs/reference/api/">Facebook Graph API</a>.',
'             In interaction with API ' +
'             <a href="https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest">XMLHttpRequests</a>',
'             should be sent using <a href="http://api.jquery.com/jQuery.ajax/">jQuery Ajax</a>.',
'           </p>',
'         </li>',
'         <li>',
'           <p>For plotting friends network with D3js ' +
'             <a href="http://mbostock.github.io/d3/talk/20111116/force-collapsible.html">Collapsible Force Layout</a>' +
'              should be used.',
'           </p>',
'         </li>',
'         <li>',
'           <p>Graph should contain friend and friend of friends. Mouse double click invokes expending/collapsing of node.',
'           </p>',
'         </li>',
'         <li>',
'           <p>On single mouse click on the node corresponding user info (name, gender, location, age range, # of friends) should be shown in ' +
'              <a href="http://twitter.github.io/bootstrap/javascript.html#popovers">popover</a>.',
'           </p>',
'         </li>',
'         <li>',
'           <p>"Info" field should show number of 1st-degree and 2nd-degree connection, and how many users from 1st ' +
'               circle connected between themselves. Also, it should provide an option to expand or collapse all the nodes in graph.',
'           </p>',
'         </li>',
'       </ul>',
'    </div>',
